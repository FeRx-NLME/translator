;; Source: amp.sim package (LeidenAdvancedPKPD/amp.sim), inst/example_models/PK.1CMT.ORAL.mod
;; Description: 1 CMT PK model with oral absorption (ADVAN6 ODE, theophylline data)
